...
function buildCharts(sample){
    d3.json("https://2u-data-curriculum-team.s3.amazonaws.com/dataviz-classroom/v1.1/14-Interactive-Web-Visualizations/02-Homework/samples.json").then((data) => {
        ...
        // Bubble chart of OTUs found per indivdual with the marker size dependent on the sampleValue
        let bubbleLayout = {
        ...
        // Horizontal bar chart that displays the top 10 OTUs found per individual
